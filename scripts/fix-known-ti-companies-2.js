...
const COMPANY_PATTERNS = ['%ecolab%', '%chiesi%', '%alfasigma%', '%recordati%', '%becton%', '%amplifon%'];

async function run() {
  console.log('🔧 Ecolab / Chiesi / Alfasigma / Recordati / Becton Dickinson / Amplifon — NULL → TI (confermato dall\'utente)\n');
