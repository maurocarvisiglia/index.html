...
async function main(){
  console.log('🔎 Estrazione dati MSL aggiornati (post-fix coerenza)...\n');
...
<title>Market Intelligence — Medical Science Liaison (v2, post-fix)</title>
<style>
...
<div class="page">
  <div class="header">
    ...
    <div style="text-align:right;">
      <div style="font-size:10px;letter-spacing:2px;text-transform:uppercase;color:#888;margin-bottom:4px;">Market Intelligence Report — v2 (post-fix grafici)</div>
  ...
  <div style="font-size:12px;color:#888;margin-bottom:8px;">Base: <strong>${listings.length}</strong> annunci reali (canonical_role, post-fix coerenza)</div>
  ...
  <div class="footer">
    Report v2 — grafici corretti (bucket adattivo + esclusione outlier IQR) su ${listings.length} annunci Medical Science Liaison.<br>
  ...
  fs.writeFileSync('C:\\Users\\Utente\\Downloads\\INDEX\\LS Intelligence\\scripts\\msl-report-v2-fixed.html', html);
  console.log('\n✅ Report v2 generato: scripts/msl-report-v2-fixed.html');
}
main();
